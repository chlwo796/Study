;(function($, window, undefined){
	...
	var Slider = Newriver.Slider = {
		...
		MainVisual : function(){
			var customPager = $('#main_visual .bx-custom-pager');
			var slideObj = $('#main_visual .bx-slider li');
			var customPagerOldClass = '';
			var customPagerNewClass = '';
			var videoBoolean = $('#main_visual').find('iframe').length;
			var firstSlide = $('#main_visual .bx-slider li').eq(0).find('iframe');

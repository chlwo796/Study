...
UPDATE USER_INFO SET UI_FILEPATH = '/resources/upload/3fd3d02a-15f4-49a3-9cb4-d67117be4c43.png' WHERE UI_NUM = 1;
SELECT UI_FILEPATH, UI_NICKNAME, c.CI_CONTENT, c.CI_CREDAT, c.CI_CRETIM FROM COMMENT_INFO c JOIN USER_INFO u ON c.UI_NUM = u.UI_NUM;
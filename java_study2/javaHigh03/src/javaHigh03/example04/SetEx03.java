...
public class SetEx03 {
	public static void main(String[] args) {
		...
		shopSet.add(new Shop("¿Ã±‚ª›", "1234", 100));
		shopSet.add(new Shop("±Ë«‡∫π", "2345", 90));
		shopSet.add(new Shop("π⁄ºˆ¡¯", "1566", 300));
		shopSet.add(new Shop("¡§±‚ª›", "1234", 100));
		shopSet.add(new Shop("√÷±‚ª›", "1234", 80));
		shopSet.add(new Shop("√÷±‚ª›", "1234", 100));
		...
		if (!searchOK) {
			System.out.println(searchName + "∞˙ " + searchPhone + " ∞Ì∞¥¿∫ æ¯Ω¿¥œ¥Ÿ.");
		}
	}
}
